...
async def get_transactions(
    ...
    for t in transactions:
        ...
        # Debits (negative): SUBSCRIPTION_PAYMENT, WITHDRAWAL, GIFT_PAYMENT, PROXY_PURCHASE
        is_debit = t.type in ['subscription_payment', 'withdrawal', 'gift_payment', 'proxy_purchase']
